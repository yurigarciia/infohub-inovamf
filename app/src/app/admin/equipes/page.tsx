...
/** Funil/kanban de equipes (RF-06, RF-07) — desde o T-FE-28, a home da
 * área administrativa é o dashboard (`/admin`); esta tela vive em
 * `/admin/equipes`. RNF-03: restrito a ADMIN/MENTOR — aluno ou
 * visitante não autenticado não deve ver dados internos de nenhuma
 * equipe aqui. */
